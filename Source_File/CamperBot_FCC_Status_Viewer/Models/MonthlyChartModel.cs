...
namespace CamperBot_FCC_Status_Viewer.Models
{
    ...
    {
        public static List<monthly_update_list> DatabaseConnection()
        {
            List<monthly_update_list> monthlyUpdateList = new List<monthly_update_list>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    monthly_update_list temp_data = new monthly_update_list()
                    {
    ...
    // Template for list
    public class monthly_update_list
    {
